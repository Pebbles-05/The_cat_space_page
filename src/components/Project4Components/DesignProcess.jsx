        ...
        <div className='Contents mt-4'>
          <div className='grid md:grid-cols-11 grid-cols-1'>
            <div className='flex flex-col align-top'>
              <p className='flex md:justify-start justify-center'>Discover</p>
              <p className='flex justify-center pink-text md:text-left text-center'>
                User Interviews
              </p>
            </div>
            ...
            <div className='flex flex-col align-top'>
              <p className='flex md:justify-start justify-center'>Ideate</p>
              <p className='flex justify-center pink-text md:text-left text-center'>
            ...
            <div className='flex flex-col align-top'>
              <p className='flex md:justify-start justify-center'>Usability Testing</p>
              <p className='flex justify-center pink-text md:text-left text-center'>
            ...
            <div className='flex flex-col align-top'>
              <p className='flex md:justify-start justify-center'>Final Screens</p>
              <p className='flex justify-center pink-text md:text-left text-center'>
