...
useEffect(() => {
 ...
 return (
    <div  className="hero"  >
        ...
        <div className="hero__footer"   data-aos="fade" data-aos-duration="3000" data-aos-offset="0">
            <div></div>
