        ...
        <div className='Contents mt-4'>
          <div className='grid md:grid-cols-9 grid-cols-1'>
            <div className='flex flex-col align-top'>
              ...
              <p className='flex justify-center text-lg pink-text text-center'>Fix basic UI</p>
            </div>
            ...
            <div className='flex flex-col align-top'>
              ...
              <p className='flex justify-center text-lg pink-text text-center'>
            ...
            <div className='flex flex-col align-top'>
              <p className='flex justify-center text-lg'>Design</p>
              <p className='flex justify-center text-lg pink-text text-center'>Design the solutions ideated</p>
            </div>
            <div className='flex justify-center py-7 mb-1 md:mt-1 rotate-90 md:rotate-0'>
              <div className='w-1/12 md:w-1/3'>{Arrow}</div>
            </div>
