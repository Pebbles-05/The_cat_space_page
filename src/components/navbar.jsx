  ...
  return (
    <div className={`nav_container ${isactive? 'nav_active' : null}`}>
        ...
        <hr />
              ...
              <li onClick={handleactive} className={isactive ? 'active' : null} style={ isactive?   {transition:`opacity .3s ease-in ${1/7+0.1}s,font-size 0.3s ease-in`} : null}> <HashLink  to='/#hero'> Home  </HashLink></li>
              <li onClick={handleactive} className={isactive ? 'active' : null} style={ isactive?   {transition:`opacity .3s ease-in ${2/7+0.1}s,font-size 0.3s ease-in`} : null}> <HashLink  to="/#projects">  Projects </HashLink></li>
              <li onClick={handleactive} className={isactive ? 'active' : null} style={ isactive?   {transition:`opacity .3s ease-in ${3/7+0.1}s,font-size 0.3s ease-in`} : null}> <HashLink  to="/#reviews">Reviews</HashLink></li>
              <li onClick={handleactive} className={isactive ? 'active' : null} style={ isactive?   {transition:`opacity .3s ease-in ${4/7+0.1}s,font-size 0.3s ease-in`} : null}> <Link  to="about">About Me</Link></li>
