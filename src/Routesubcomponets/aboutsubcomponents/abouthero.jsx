  ...
  return (
    <div className='abouthero'>
        <div className="abouthero__profile">
          <div className="bg" data-aos="fade-up" data-aos-duration="500" data-aos-once="true"> <img loading='eager' style={{transform:`translateY(${scroll * -150}%)`}} src="https://ik.imagekit.io/thecatspace/catspace_media/the_picturesfinal.png" alt="profilebg" /></div>
